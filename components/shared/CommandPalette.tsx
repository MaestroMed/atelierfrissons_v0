...
const ITEMS: readonly CommandItem[] = [
  ...
  // Collections
  {
    ...
    description: 'Objets clairs, matins lents',
    group: 'Collections',
    href: '/collections/jour',
    keywords: ['jour', 'ivoire', 'clair'],
  },
  {
    id: 'col-nuit',
    label: 'Collection NUIT',
    description: 'Objets sombres, rituels du soir',
    group: 'Collections',
    href: '/collections/nuit',
    keywords: ['nuit', 'noir', 'rouge', 'soir'],
  },

  // Produits (mock — sera remplacé par queries Sprint 2+)
  {
    id: 'p-premier-frisson',
    label: 'Premier Frisson',
    description: 'JOUR — 89 €',
    group: 'Objets',
    href: '/produit/premier-frisson',
  },
  {
    id: 'p-velours-rouge',
    label: 'Velours Rouge',
    description: 'NUIT — 129 €',
    group: 'Objets',
    href: '/produit/velours-rouge',
  },
  {
    id: 'p-essentiel-jour',
    label: 'Essentiel Jour',
    description: 'JOUR — 79 €',
    group: 'Objets',
    href: '/produit/essentiel-jour',
  },
  {
    id: 'p-noir-profond',
    label: 'Noir Profond',
    description: 'NUIT — 149 €',
    group: 'Objets',
    href: '/produit/noir-profond',
  },
  {
    id: 'p-albatre',
    label: 'Albâtre',
    description: 'JOUR — 109 €',
    group: 'Objets',
    href: '/produit/albatre',
  },
  {
    id: 'p-laque-minuit',
    label: 'Laque Minuit',
    description: 'NUIT — 139 €',
    group: 'Objets',
